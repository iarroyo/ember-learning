...
module('Integration | Component | hello-message', function (hooks) {
  ...
  test('it renders a greeting with the provided name', async function (assert) {
    await render(<template><HelloMessage @name="Ember" /></template>);
